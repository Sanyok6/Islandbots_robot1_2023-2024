...
public class Trajectories_low {
    ...
    public Trajectories_low(MecanumDrive drive, StartingPosition startingPosition) {
        this.startingPosition = startingPosition;

        Pos3 = drive.actionBuilder(new Pose2d(-15, yCoordinate(-60), angle(90)))
                .strafeToSplineHeading(new Vector2d(-15, yCoordinate(-35)), angle(0))
                .build();

        Pos2 = drive.actionBuilder(new Pose2d(-15, yCoordinate(-60), angle(90)))
                .lineToY(yCoordinate(-35))
                .build();

        Pos1 = drive.actionBuilder(new Pose2d(-15, yCoordinate(-60), angle(90)))
                .strafeToSplineHeading(new Vector2d(-11, -35), angle(180))
                .build();

        Pos_end = drive.actionBuilder(new Pose2d(-15, yCoordinate(-35), angle(90)))
                .strafeToSplineHeading(new Vector2d(-15, yCoordinate(-58)), angle(0))
        ...
        toBackdropPos2 = drive.actionBuilder(new Pose2d(-48, yCoordinate(-38), angle(0)))
                .strafeTo(new Vector2d(-53,yCoordinate(-35)))
                .build();
        toBackdropPos1 = drive.actionBuilder(new Pose2d(-48, yCoordinate(-38), angle(0)))
                .setTangent(Math.toRadians(-90))
                .lineToY(-42)
                .build();
        toBackdropPos3 = drive.actionBuilder(new Pose2d(-48, yCoordinate(-38), angle(0)))
                .setTangent(Math.toRadians(-90))
                .lineToY(-27)
                .build();

        BackdropToMid2 = drive.actionBuilder(new Pose2d(-53, yCoordinate(-35), angle(0)))
                .strafeTo(new Vector2d(-48,yCoordinate(-38)))
                .build();
